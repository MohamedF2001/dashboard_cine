        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow('Booked on', '${reservation.formattedDate} at ${reservation.formattedTime}'),
              SizedBox(height: 24),
       ...
       child: _isLoading
         ...
         child: Container(
           child: Column(
             ...
             children: [
               Icon(Icons.movie_creation_outlined, size: 50, color: Colors.white),
               SizedBox(height: 16),
               Text(
                           ...
                           Expanded(
                             child: Column(
                               ...
                               children: [
                                 ...
                                 Text("Réservation de ${reservation.user.nom}",
                                   style: TextStyle(color: Colors.white,),),
                                 SizedBox(height: 8),
                                 Row(
                                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                   children: [
                                     Chip(
                                       label: Text(
                                         reservation.statut,
                                         style: TextStyle(
                                           color: reservation.statut.toLowerCase() == 'confirmée'
                                               ? Colors.green
                                               : Colors.orange,
                                         ),
                                       ),
                                       backgroundColor: reservation.statut.toLowerCase() == 'confirmée'
                                           ? Colors.green[50]
                                           : Colors.orange[50],
                                     ),
                                     Text(
                                       '${reservation.nombrePlaces} seat${reservation.nombrePlaces > 1 ? 's' : ''}',
